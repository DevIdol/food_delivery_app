...
class _$RefreshTokenResponseImpl implements _RefreshTokenResponse {
  ...
  @override
  String toString() {
    return 'RefreshTokenResponse(status: $status, name: $name, message: $message, accessToken: $accessToken, refreshToken: $refreshToken)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, status, name, message, accessToken, refreshToken);
